...
public class GameController {
    ...
    //@FXML
    //public AnchorPane AnchorPaneAll;
    ...
    @FXML
    private ImageView firstAiCardsAfterFoldOne;
    @FXML
    private ImageView firstAiCardsAfterFoldTwo;
    @FXML
    private ImageView secondAiCardsAfterFoldOne;
    @FXML
    private ImageView secondAiCardsAfterFoldTwo;
    @FXML
    private ImageView thirdAiCardsAfterFoldOne;
    @FXML
    private ImageView thirdAiCardsAfterFoldTwo;
    @FXML
    private ImageView fourthAiCardsAfterFoldOne;
    @FXML
    private ImageView fourthAiCardsAfterFoldTwo;
    @FXML
    private ImageView fifthAiCardsAfterFoldOne;
    @FXML
    private ImageView fifthAiCardsAfterFoldTwo;
